...
No third-party community ONNX weights are used. The graph is exported from the pinned official checkpoint with a static `image` `[1,3,294,392]` input and `depth` `[1,1,294,392]` meter output.
